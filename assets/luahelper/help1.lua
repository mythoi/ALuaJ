...
helpStr=[===[
@前言@
@它在AndroLua的基础上做了以下几点的修改
1.同时支持init.lua和原生的AndroidManifest.xml
2.增加了xml布局的支持
3.相对于AndroLua的文件结构更复杂
4.增加了java，xml等文件编译，并且合并类到AndroLua的dex文件上
@
@关于AndroLua@
...
@软件基本操作@
@工程结构
init.lua 工程配置文件 (在AndroLuaJ中舍弃了init.lua，而是使用了原生的AndroidManifest.xml)
main,lua 工程主入口文件
layout.aly  工程默认创建的布局文件(在AndroLuaJ中增加了xml布局的支持)
...
@14.6 bmob 网络数据库@
@b=bmob(id,key,token)
id 是Application ID，key 是REST API Key，token 用户身份识别码(可选)。
